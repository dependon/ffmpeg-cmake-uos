...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--extra-libs=-lpthread --extra-libs=-lm --enable-gpl --enable-libx264 --enable-nonfree --disable-asm
prefix=/usr/local
...
CC_IDENT=gcc 8 (Uos 8.3.0.5-1+dde)
ARCH=c
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
...
EXTRALIBS-avcodec=-pthread -lm -llzma -lcrystalhd -lz -lx264 -lva
